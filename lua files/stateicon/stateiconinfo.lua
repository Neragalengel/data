...
StateIconList[EFST_IDs.EFST_PLUSAVOIDVALUE] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"AutoRefresh Client", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
		{"Time Remaining to Refresh your Screen"}
	}
}
...
StateIconList[1002] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Halo-Halo Effect", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
		{"All Stats +3."}
	}
}
...
StateIconList[1005] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Box Of Sunlight", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
...
StateIconList[1006] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Poem Song", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
		{"You're under Poem Of Bragi Song. This song decrease delays, cast time."}
	}
}
...
StateIconList[1007] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Apple Song", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
		{"You're under Apple Idun Song. This song increase your HP"}
	}
}
...
StateIconList[1008] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Assasing Song", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
		{"You're under Assasin Cross Song. This song increase your speed & ASPD"}
	}
}
...
StateIconList[1009] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Service 4u Song", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
		{"You're under Service For You Song (increase sp, decrease sp usage)"}
	}
}
...
StateIconList[1010] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Dont Forget Song", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME},
		{"You're under Dont Forget Me Song. This song decrease your speed & ASPD"}
	}
}
...
StateIconList[1013] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Rainbow Cake", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME}, 
		{"Increases ATK and MATK"}, 
	}
}
-- INCATKRATE, INCMATKRATE
StateIconList[1014] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Rune Strawberry Cake", COLOR_TITLE_BUFF},
		{"%s", COLOR_TIME}, 
		{"Increases ATK and MATK"}, 
	}
}
...
StateIconList[1021] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Frozen", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
		{"All DEF contributed by items is reduced by 50%"},
		{"Any FLEE will be negated"}, 
		{"If HP is over 25%, you will lose 1% of your HP every 5 seconds"}, 
		{"Changes your elemental status as Water LV 1"},
		{"Ignores Steal, Lex Aeterna, Storm Gust and Snow Flake Draft"}, 
		{"Impossible to move, attack, pick up items, skill usage, sitting, force disconnection, and item usage"}
	}
}
